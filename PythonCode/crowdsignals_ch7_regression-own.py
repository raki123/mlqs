...
train_X, test_X, train_y, test_y = prepare.split_single_dataset_regression_by_time(dataset, 'light_phone_lux', '2016-02-08 18:28:56',
...
basic_features = ['acc_phone_x','acc_phone_y','acc_phone_z','gyr_phone_x','gyr_phone_y','gyr_phone_z','labelOnTable','labelSitting','labelSmoking','labelWalkingStairs','labelStandingInElevator','mag_phone_x','mag_phone_y','mag_phone_z']
