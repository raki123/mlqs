...
current_value = np.array([2.5,3])
x_values = [2.5]
y_values = [3]
V, U = np.gradient(Z, 0.1,0.1)
stepss = [14,1000, 10000]
rates = [1.1, 0.8, 0.1]
for i in range(3):
	...
	for i in range(0, steps):
	    current_value = current_value - [learning_rate*V[current_value[0]/0.1, current_value[1]/0.1], learning_rate*U[current_value[0]/0.1, current_value[1]/0.1]]
