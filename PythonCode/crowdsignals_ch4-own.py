...
periodic_predictor_cols = ['acc_phone_x','acc_phone_y','acc_phone_z','gyr_phone_x','gyr_phone_y','gyr_phone_z','mag_phone_y','mag_phone_z']
...
#DataViz.plot_dataset(dataset, ['acc_phone_x', 'gyr_phone_x', 'light_phone_lux', 'mag_phone_x', 'pca_1', 'label'], ['like', 'like', 'like', 'like', 'like','like'], ['line', 'line', 'line', 'line', 'line', 'points'])
